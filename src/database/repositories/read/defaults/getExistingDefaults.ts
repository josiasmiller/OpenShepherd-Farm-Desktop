      ...
      if (err) {
        ...
        const results: DefaultSettingsResults[] = rows.map((row: any) => {
          ...
          return {
            ...
            id_eid_tag_male_color_female_color_same: String(row.id_eid_tag_male_color_female_color_same),
            ...
            id_farm_tag_male_color_female_color_same: String(row.id_farm_tag_male_color_female_color_same),
            ...
            id_fed_tag_male_color_female_color_same: String(row.id_fed_tag_male_color_female_color_same),
            ...
            id_nues_tag_male_color_female_color_same: String(row.id_nues_tag_male_color_female_color_same),
            ...
            id_trich_tag_male_color_female_color_same: String(row.id_trich_tag_male_color_female_color_same),
            ...
            id_bangs_tag_male_color_female_color_same: String(row.id_bangs_tag_male_color_female_color_same),
            ...
            id_sale_order_tag_male_color_female_color_same: String(row.id_sale_order_tag_male_color_female_color_same),
