...
export { endAnimalLeaseFromDeath } from "./repositories/write/animal/death/endAnimalLeaseFromDeath";
export { endMaleBreedingFromDeath } from "./repositories/write/animal/death/endMaleBreedingFromDeath";
