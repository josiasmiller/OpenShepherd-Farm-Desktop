...
from AnimalTrakker_Shared.Shared_Database.Shared_Utilities import DatabaseConnection, file_picker

from AnimalTrakker_FarmDesktop.FarmDesktop_UserInterface.FarmDesktop_GUI import FarmDesktop_GUI
from AnimalTrakker_FarmDesktop.FarmDesktop_Database.FarmDesktop_Utilities import fetch_evaluation_history
...
def main():
    ...
    # Prompt the user to select a database file at the start
    currentdatabase = file_picker()
    
    # Initialize the database connection
    db_connection = DatabaseConnection(currentdatabase)
    ...
    app = FarmDesktop_GUI(root, sidebar_title="AnimalTrakker - Farm Desktop", tree_structure=tree_data, controller=controller, currentdatabase=currentdatabase, db_connection=db_connection)
